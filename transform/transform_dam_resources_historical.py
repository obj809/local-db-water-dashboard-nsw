...
INPUT_DIR = os.path.join(PROJECT_ROOT, "input_data", "dam_resources_historical")
OUTPUT_FILE = os.path.join(PROJECT_ROOT, "output_data", "dam_resources.json")


def transform_dam_resources(file_path: str) -> list[dict]:
    """Transform a dam resources historical file to match schema.sql format."""
    ...
    # Historical data has flat structure: resources[] directly
